...
urlpatterns = patterns('',
    ...
    url(r'^cidr/(?P<pk>\d+)/delete', views.CidrDeleteView.as_view(),
        name='cidr_delete'),
    url(r'^hostname/$', views.HostnameListView.as_view(), name='hostname_index'),
    url(r'^hostname/create$', views.HostnameCreateView.as_view(), name='hostname_create'),
    url(r'^hostname/(?P<pk>\d+)/edit', views.HostnameUpdateView.as_view(),
        name='hostname_edit'),
    url(r'^hostname/(?P<pk>\d+)/delete', views.HostnameDeleteView.as_view(),
        name='hostname_delete'),
